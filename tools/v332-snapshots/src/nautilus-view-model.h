...
void nautilus_view_model_set_group_by_type (NautilusViewModel *self, gboolean enabled);
...
GListModel *nautilus_view_model_dup_group_roots_model (NautilusViewModel *self);
gboolean nautilus_view_model_get_group_collapsed (NautilusViewModel *self,
                                                  const char        *key);
void nautilus_view_model_set_group_collapsed (NautilusViewModel *self,
                                              const char        *key,
                                              gboolean           collapsed);
guint nautilus_view_model_get_position_for_item (NautilusViewModel *self,
                                                 NautilusViewItem  *item);
gboolean nautilus_view_model_find_group_item (NautilusViewModel *self,
                                              NautilusViewItem  *item,
